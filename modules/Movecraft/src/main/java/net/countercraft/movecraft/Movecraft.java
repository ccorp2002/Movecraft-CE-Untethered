...
public class Movecraft extends JavaPlugin implements AbstractMovecraft {
    ...
    public final BlockData AirBlockData = Material.AIR.createBlockData();
    public final BlockData WaterBlockData = Material.WATER.createBlockData();
    ...
    public static synchronized Movecraft getPlugin() {
        return getInstance();
    }

    public static synchronized CraftManager getCraftManager() {
    ...
    public boolean doesObjectContainField(Object object, String fieldName) {
        return getWorldHandler().doesObjectContainField(object,fieldName);
    }
    ...
    public void onEnable() {
        ...
        Settings.IS_MULTITHREADED = getConfig().getBoolean("IsMultithreaded", false);
        ...
        if (!compatMode) {
            try {
                final Class<?> worldHandlerClazz = Class.forName("net.countercraft.movecraft.compat." + NMS + ".IWorldHandler");
                ...
                if (WorldHandler.class.isAssignableFrom(worldHandlerClazz)) { // Make sure it actually implements NMS
                    ...
                    try {
                        final Class<?> smoothTeleportClazz = Class.forName("net.countercraft.movecraft.support." + NMS + ".ISmoothTeleport");
