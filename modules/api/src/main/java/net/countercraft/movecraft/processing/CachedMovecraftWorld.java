...
import net.countercraft.movecraft.AbstractMovecraft;
...
public final class CachedMovecraftWorld implements MovecraftWorld {
    ...
    private static WorldHandler getWorldHandler() {
        return AbstractMovecraft.getInstance().getWorldHandler();
    }
    ...
    public static MovecraftWorld ofSync(@NotNull World world){
        MovecraftWorld movecraftWorld = new CachedMovecraftWorld(world);
        WORLDS.put(world, movecraftWorld);
        return movecraftWorld; 
    }

    @NotNull
    public Material getMaterialSync(@NotNull MovecraftLocation location){
        return getWorldHandler().toBukkitBlockFast(location,world);
    }

    @NotNull
    public BlockData getDataSync(@NotNull MovecraftLocation location){
        return getWorldHandler().getBukkitBlockFast(location,world).getBlockData();
    }

    @NotNull
    public BlockState getStateSync(@NotNull MovecraftLocation location) {
        return getWorldHandler().getBukkitBlockFast(location,world).getState();
    }
