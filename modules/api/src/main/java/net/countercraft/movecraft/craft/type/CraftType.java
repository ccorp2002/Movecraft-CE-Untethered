...
final public class CraftType {
    ...
    public static final NamespacedKey DETECT_INTERIOR = buildKey("detect_interior");
    ...
    @Contract("_ -> new")
    public static @NotNull NamespacedKey buildKey(String key) {
    ...
    static {
        ...
        registerProperty(new BooleanProperty("detectInterior", DETECT_INTERIOR, type -> true));
        ...
        registerProperty(new DoubleProperty("sinkPercent", SINK_PERCENT, type -> 0.75D));
        registerProperty(new DoubleProperty("overallSinkPercent", OVERALL_SINK_PERCENT, type -> 0.675D));
