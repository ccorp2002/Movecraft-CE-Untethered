...
public class UnsafeDetectionTask implements Supplier<Effect> {
    ...
    public UnsafeDetectionTask(@NotNull MovecraftLocation startLocation, @NotNull MovecraftWorld movecraftWorld,
    ...
    public Effect get() {
        ...
        result = Result.succeedWithMessage("Unsafe Craft Piloted");
        if (!result.isSucess()) {
    ...
    public String toString(){
        return String.format("UnsafeDetectionTask{%s:%s:%s}", player, type, startLocation);
    }
