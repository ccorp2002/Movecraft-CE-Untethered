...
public class HitBoxDetectionTask implements Supplier<Effect> {
    ...
    public HitBoxDetectionTask(@NotNull List<String> mat, @NotNull MovecraftLocation startLocation, @NotNull MovecraftWorld movecraftWorld,
    ...
    private class DetectAction implements Runnable {
        ...
        public void run() {
            ...
            while((probe = currentFrontier.poll()) != null) {
                ...
                if (mat.contains(movecraftWorld.getData(probe).getAsString(false).toLowerCase()) || mat.contains(movecraftWorld.getMaterial(probe).toString().toLowerCase())) {
                    continue;
                }
                if(result.isSucess()) {
                    legal.add(probe);
                    ...
                    for(MovecraftLocation shift : SHIFTS) {
                        ...
                        if (mat.contains(movecraftWorld.getData(shifted).getAsString(false).toLowerCase()) || mat.contains(movecraftWorld.getMaterial(shifted).toString().toLowerCase())) {
